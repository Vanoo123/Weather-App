                    ...
                    content.innerHTML = `<div class="weather-wrapper">
                        ...
                        data.wind.speed * 10
                                ...
                                <li class="info-item">
                                    ...
                                    <p class="info-item-title">${data.main.humidity
                        }%</p>
                                </li>
                                <li class="info-item">
                                    <div class="icon">
                                    ...
                                    <p class="info-item-title">${data.visibility / 1000
                        } km</p>
                                </li>
                                <li class="info-item">
                                    <div class="icon">
                                    ...
                                    <p class="info-item-title">${data.main.temp_min
                        }°</p>
                                </li>
                                <li class="info-item">
                                    <div class="icon">
                                    ...
                                    <p class="info-item-title">${data.main.temp_max
                        }°</p>
                                </li>
                            </ul>
                        </div>
